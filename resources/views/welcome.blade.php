    ...
    <body class="font-sans antialiased">
            ...
            <div class="container">
                ...
                <form action="/search" method="get">
                    <input type="text" placeholder="Search Here" name="search" value="{{ isset($search) ? $search : ''}}">
                    ...
                    <div class="-m-1.5 overflow-x-auto">
                        ...
                        <div class="overflow-hidden">
                            ...
                            <thead>
                                ...
                                <th scope="col" class="px-6 py-3 text-end text-xs font-medium text-gray-500 uppercase">Hobbies</th>
                            ...
                            <tbody class="divide-y divide-gray-200">
                                @foreach ($posts as $post)
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800">
                                        @php
                                            $hobbies = json_decode($post->hobbies);
                                        @endphp
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-end text-sm font-medium">
                                        ...
                                        <a href="{{route('delete', $post->id)}}" class="bg-red-600 text-white rounded py-2 px-4" onclick="return confirm('Are you sure want to delete this data?'); " >Delete</a>
                                    </td>
                                    </tr>                                    
                                @endforeach              
